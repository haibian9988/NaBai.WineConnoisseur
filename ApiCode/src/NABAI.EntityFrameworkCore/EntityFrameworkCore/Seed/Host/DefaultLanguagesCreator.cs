...
namespace NABAI.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly NABAIDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = NABAIConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(NABAIDbContext context)
        {
            _context = context;
        }
